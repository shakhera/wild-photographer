...
const Footer = () => {
  return (
    <section className=" bg-neutral text-base-100 px-3">
      <footer className="container mx-auto py-6 flex flex-col">
        <div className="flex flex-col justify-around gap-5py-8 md:flex-row md:gap-0 items-center">
        ...
        <hr />
        <aside className="bg-neutral text-base-100 py-5 text-center text-sm">
          <p>&copy; 2024 Wild-Photographer. All Rights Reserved.</p>
        </aside>
      </footer>
    </section>
  );
